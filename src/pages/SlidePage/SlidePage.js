        ...
        <>
            ...
            >
                ...
                <SwiperSlide> 
                    <div className="banner p-4 md:px-8 lg:px-12 md:py-6 lg:py-10">
                        <img className='max-h-[430px] w-full' src={banner} alt="" />
                        <h2 className="slide-title absolute top-1/3 left-1/2 text-4xl font-bold text-[#e7dd48]">Your Financial Journey Starts Here</h2>
                ...
                <SwiperSlide> 
                    <div className="banner p-4 md:px-8 lg:px-12 md:py-6 lg:py-10">
                        <img className='max-h-[430px] w-full' src={banner} alt="" />
                        <h2 className="slide-title absolute top-1/3 left-1/2 text-4xl font-bold ">Savings, Investments, and More</h2>
                ...
                <SwiperSlide>
                    <div className="banner p-4 md:px-8 lg:px-12 md:py-6 lg:py-10">
                        <img className='max-h-[430px] w-full' src={banner} alt="" />
                        <h2 className="slide-title absolute top-1/3 left-1/2 text-4xl font-bold ">Safe and Secure Card Transactions</h2>
                ...
                <SwiperSlide>
                    <div className="banner p-4 md:px-8 lg:px-12 md:py-6 lg:py-10">
                        <img className='max-h-[430px] w-full' src={banner} alt="" />
                        <h2 className="slide-title absolute top-1/3 left-1/2 text-4xl font-bold ">Banking That Puts You First</h2>
