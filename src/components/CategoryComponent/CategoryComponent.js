          ...
          {/* allInfos.filter((singleInfo) => singleInfo.category === selected) */}
          {
            mainFiltered
              ...
              bg-[#9EDDFF]">
                  ...
                  <div className='font-medium  text-justify'>Enjoy <span className='font-bold text-red-500 text-lg md:text-2xl'>{singleInfo.discountdetail}</span><br /><span className=''>& Exciting Deals</span> <br /> with your<span className='font-bold'> {singleInfo.bankshortname} {singleInfo.cardtype}</span> <p></p></div>
