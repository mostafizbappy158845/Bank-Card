    ...
    return (
        <>
            ...
            <div className=' bg-gray-100  m-8  grid grid-cols-1 md:grid-cols-2 gap-8'>
                <div className='sm:w-1/2 ml-8 mt-4 h-auto' data-aos="fade-left" data-aos-duration="2000" data-aos-mirror="false" data-aos-offset="200">
                ...
                <div className='sm:w-1/2 relative'  >
                    ...
                    <img src={img} alt="" className='md:absolute mb-8 md:mb-0  z-20' data-aos="fade-left" data-aos-duration="2000" data-aos-mirror="false"/>
                    <img src={img} alt="" className='md:absolute top-[18%] left-[60%] mb-0 z-10' data-aos="fade-right" data-aos-duration="2000" data-aos-mirror="false"/>
