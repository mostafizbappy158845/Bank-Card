  ...
  return (
    <div>
            <div className='mt-14 mx-4'>
                <p className='text-2xl lg:text-4xl font-mono md:font-semibold flex flex-start  mt-4 uppercase text-rose-500'>Hot offer</p>
            ...
            <div className='main-part flex flex-col lg:flex-row min-h-[500px]'>
                <div className="left-seection w-full lg:w-4/5 grid grid-cols-1 md:grid-cols-2 gap-4 px-4">
                    ...
                    <div className="info-item flex flex-col lg:flex-row  border border-solid border-amber-500 rounded-md px-3 py-4
                      bg-red-100">
                        <div className='text-xl md:text-2xl lg:text-4xl font-serif font-semibold md:font-bold lg:tracking-wide  lg:pt-14 mr-2 md:mr-4 lg:mr-8 uppercase'>pearl <br /> Hotel</div>
