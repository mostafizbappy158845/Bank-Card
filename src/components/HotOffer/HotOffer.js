  ...
  return (
    <div>
            <div className='mt-14 mx-4' >
                <p data-aos="flip-down" data-aos-duration="2000" className='text-xl lg:text-4xl font-mono md:font-semibold flex flex-start  mt-4 uppercase text-rose-500'data-aos="flip-down" data-aos-duration="2000">Hot offer</p>
                <hr data-aos="flip-left" data-aos-duration="2000" className='my-4 w-32 h-1 bg-gray-500 'data-aos="flip-right" data-aos-duration="2000" />
            </div>
